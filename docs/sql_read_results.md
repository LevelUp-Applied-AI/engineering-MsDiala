...
dialaabedalqader@192 engineering-MsDiala % /usr/local/bin/python3 /Users/dialaabedalqader/LevelUp/engineering-MsDiala/run_queries.py

## Interpretation

**Question 1:** Which cohort had the highest average pre-work score? What might that tell you about how cohorts differ?

[The 2024A cohort had the highest average pre-work score (81.8). This suggests that 2024A may have entered the program slightly better prepared overall compared to 2024B and 2025A.]
...
[There are 8 students who scored 80 or above. Most are from Jordan, but strong performers also come from Egypt and Palestine, suggesting high performance is distributed across countries rather than concentrated in only one.]
...
[Lina Barakat consistently submitted all projects on time with very high scores (98, 95, 96), indicating strong preparation, consistency, and high engagement with coursework.]